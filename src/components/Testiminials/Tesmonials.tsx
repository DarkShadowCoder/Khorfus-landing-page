  ...
  return (
    <div className='pt-14 sm:pt-20 lg:pt-[130px]' id='testimonials'>
      <div className='px-4 xl:container'>
        ...
        <div className="flex justify-center px-8 gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[738px] overflow-hidden ">
