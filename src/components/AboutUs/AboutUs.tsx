    ...
    <div className='pt-14 sm:pt-20 lg:pt-[130px]'>
      <div className='px-4 xl:container'>
        <div className='w-full flex items-center justify-center'>
          ...
          title="A"
          title2="PROPOS" 
          subtitle="Decouvrez qui nous sommes" 
        ...
        <div className='absolute left-0 top-0 -z-10 h-full w-full bg-noise-pattern bg-cover bg-center opacity-10 dark:opacity-40'>
        </div>
        ...
        <div className='tabButtons flex w-full items-center justify-around'>
          ...
          <button className='w-full border-b px-2 pb-6 pt-8 font-heading text-base font-medium lg:pb-7 lg:pt-9  hover:text-primary border-[#4B4E56] text-white hover:border-primary'>
            Notre Mission
          </button>
          <button className='w-full border-b px-2 pb-6 pt-8 font-heading text-base font-medium lg:pb-7 lg:pt-9  hover:text-primary border-[#4B4E56] text-white hover:border-primary'>
            Notre Vision
