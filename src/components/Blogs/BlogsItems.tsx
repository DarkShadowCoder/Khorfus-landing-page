    ...
    <div className='w-full px-4 md:w-1/2 lg:w-1/3 lg:max-w-[400px]'>
      <div className='mb-10'>
        <div className='relative mb-8 overflow-hidden rounded-lg'>
          ...
          <a href="" className='absolute left-5 top-5 rounded bg-primary px-4 py-[6px] font-heading text-sm font-medium text-white'>
            Publié
          </a>
